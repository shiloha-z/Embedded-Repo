...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_color(ui->screen, lv_color_hex(0x24e26d), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_dither_mode(ui->screen, LV_DITHER_ERR_DIFF, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen, LV_GRAD_DIR_HOR, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui->screen, lv_color_hex(0x24c9db), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_main_stop(ui->screen, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_stop(ui->screen, 148, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 14, 38);
