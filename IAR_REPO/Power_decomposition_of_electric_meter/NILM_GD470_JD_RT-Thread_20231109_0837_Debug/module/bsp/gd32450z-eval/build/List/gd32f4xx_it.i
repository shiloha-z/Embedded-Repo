...
void DMA0_Channel0_IRQHandler(void)
{
   ...
   if ((dma_flag_get(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH0, ((uint32_t)((uint32_t)0x01U<<(5)))) != RESET))
       
    {
          HAL_SPI_RxCpltCallback();
        
    }	
   dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U)), DMA_CH0,((uint32_t)((uint32_t)0x01U<<(5))));
...
void USART0_IRQHandler_Uart0(void)
{
    ...
    if(usart_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00004400U)+0x0000CC00U), USART_INT_FLAG_RBNE) != RESET)
    {
          
          
          LED_USART1Working = 1;
          USARTx_Rcv_IRQHandler(0, (uint8_t)usart_data_receive(((((uint32_t)0x40000000U) + 0x00004400U)+0x0000CC00U)));
...
void DMA1_Channel7_IRQHandler(void)
{
   rt_interrupt_enter();
    ...
    if (dma_flag_get(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH7, ((uint32_t)((uint32_t)0x01U<<(5)))) != RESET)
    {
      USARTx_SendComplete_IRQHandler(0);
        
    }	
    dma_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH7, ((uint32_t)((uint32_t)0x01U<<(0)))|((uint32_t)((uint32_t)0x01U<<(2)))|((uint32_t)((uint32_t)0x01U<<(3)))|((uint32_t)((uint32_t)0x01U<<(4)))|((uint32_t)((uint32_t)0x01U<<(5))));
 ...
 void DMA1_Channel2_IRQHandler(void)
{
  ...
  int i;
     ...
     if (dma_interrupt_flag_get(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH2, ((uint32_t)((uint32_t)0x01U<<(5)))) != RESET)
    {
      nLen = 512 - dma_transfer_number_get(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH2);
    ...
    dma_interrupt_flag_clear(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH2,USART_INT_FLAG_IDLE);
    dma_channel_enable(((((uint32_t)0x40020000U) + 0x00006000U) + 0x0400U), DMA_CH2);
}
